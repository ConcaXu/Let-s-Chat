...
-- Records of admin
-- ----------------------------
INSERT INTO `admin` VALUES (1, 'admin', '系统管理员', '$2a$10$plbDgZhtTsBenP0PlU3o2u/mUrOErDdw3dp8AXk7JzRi7m4iyoFJ6', 'https://ss0.bdstatic.com/70cFuHSh_Q1YnxGkpoWK1HF6hhy/it/u=1784117537,3335593911&fm=26&gp=0.jpg');
...
CREATE TABLE `group_msg_content`  (
  ...
  CONSTRAINT `group_msg_content_ibfk_1` FOREIGN KEY (`from_id`) REFERENCES `user` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `group_msg_content_ibfk_2` FOREIGN KEY (`message_type_id`) REFERENCES `message_type` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
INSERT INTO `group_msg_content` VALUES (99, 23, 'zx', 'default_head.jpg', '2023-12-22 21:17:46', '有人吗\n', 1);
INSERT INTO `group_msg_content` VALUES (100, 22, 'lin', 'http://39.108.169.57/group1/M00/00/00/J2ypOV91Z_uADljOAAANuXp4Wt8245.jpg', '2023-12-22 21:18:45', '有\n', 1);
INSERT INTO `group_msg_content` VALUES (101, 22, 'lin', 'http://39.108.169.57/group1/M00/00/00/J2ypOV91Z_uADljOAAANuXp4Wt8245.jpg', '2023-12-22 21:24:17', 'aaaaaa', 1);
...
INSERT INTO `mail_send_log` VALUES ('9827a2e1-8497-433b-9d4a-ed8b76fdfc0f', 2, '4958', NULL, 2, 'mail-route-verifyCode', 'mail-exchange', 4, '2023-12-22 22:10:37', '2023-12-22 22:10:27', '2023-12-22 22:11:00');
...
INSERT INTO `mail_send_log` VALUES ('a79ca1c7-7960-4718-b4e9-1601134dac33', 2, '7161', NULL, 2, 'mail-route-verifyCode', 'mail-exchange', 4, '2023-12-22 21:10:08', '2023-12-22 21:09:58', '2023-12-22 21:10:30');
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, 'huang', '王路飞', '$2a$10$cqS47p0t3qg9L7qRerSHCOGrWRJCFXJcx/HaG9x5639fLnbl.XLf6', 'default_head.jpg', 2, 1, 0);
INSERT INTO `user` VALUES (2, 'suolong', '刘索隆', '$2a$10$cqS47p0t3qg9L7qRerSHCOGrWRJCFXJcx/HaG9x5639fLnbl.XLf6', 'default_head.jpg', 2, 1, 0);
INSERT INTO `user` VALUES (3, 'hongfa', '面子王', '$2a$10$cqS47p0t3qg9L7qRerSHCOGrWRJCFXJcx/HaG9x5639fLnbl.XLf6', 'default_head.jpg', 2, 1, 0);
INSERT INTO `user` VALUES (4, '22', '23', '$2a$10$cqS47p0t3qg9L7qRerSHCOGrWRJCFXJcx/HaG9x5639fLnbl.XLf6', 'default_head.jpg', 2, 1, 0);
INSERT INTO `user` VALUES (5, 'luojie', '罗杰', '$2a$10$cqS47p0t3qg9L7qRerSHCOGrWRJCFXJcx/HaG9x5639fLnbl.XLf6', 'default_head.jpg', 2, 1, 0);
INSERT INTO `user` VALUES (6, 'aaa', 'aaa', '$2a$10$cqS47p0t3qg9L7qRerSHCOGrWRJCFXJcx/HaG9x5639fLnbl.XLf6', 'default_head.jpg', 2, 1, 0);
INSERT INTO `user` VALUES (7, 'luo', '罗', '$2a$10$cqS47p0t3qg9L7qRerSHCOGrWRJCFXJcx/HaG9x5639fLnbl.XLf6', 'default_head.jpg', 2, 1, 0);
INSERT INTO `user` VALUES (8, 'nami', '娜美', '$2a$10$cqS47p0t3qg9L7qRerSHCOGrWRJCFXJcx/HaG9x5639fLnbl.XLf6', 'default_head.jpg', 2, 1, 0);
INSERT INTO `user` VALUES (9, 'wusuopu', '乌索普', '$2a$10$cqS47p0t3qg9L7qRerSHCOGrWRJCFXJcx/HaG9x5639fLnbl.XLf6', 'default_head.jpg', 2, 1, 0);
INSERT INTO `user` VALUES (10, 'qiaoba', '乔巴', '$2a$10$cqS47p0t3qg9L7qRerSHCOGrWRJCFXJcx/HaG9x5639fLnbl.XLf6', 'default_head.jpg', 2, 1, 0);
INSERT INTO `user` VALUES (11, 'luobin', '罗宾', '$2a$10$cqS47p0t3qg9L7qRerSHCOGrWRJCFXJcx/HaG9x5639fLnbl.XLf6', 'default_head.jpg', 2, 1, 0);
INSERT INTO `user` VALUES (12, 'fulanqi', '弗兰奇', '$2a$10$cqS47p0t3qg9L7qRerSHCOGrWRJCFXJcx/HaG9x5639fLnbl.XLf6', 'default_head.jpg', 2, 1, 0);
INSERT INTO `user` VALUES (13, 'buluke', '布鲁克', '$2a$10$cqS47p0t3qg9L7qRerSHCOGrWRJCFXJcx/HaG9x5639fLnbl.XLf6', 'default_head.jpg', 2, 1, 0);
INSERT INTO `user` VALUES (17, 'lol', 'lol', '$2a$10$cqS47p0t3qg9L7qRerSHCOGrWRJCFXJcx/HaG9x5639fLnbl.XLf6', 'default_head.jpg', 1, 1, 0);
INSERT INTO `user` VALUES (18, 'abc', 'abc', '$2a$10$cqS47p0t3qg9L7qRerSHCOGrWRJCFXJcx/HaG9x5639fLnbl.XLf6', 'default_head.jpg', 2, 1, 0);
INSERT INTO `user` VALUES (19, 'uuu', 'uuu', '$2a$10$cqS47p0t3qg9L7qRerSHCOGrWRJCFXJcx/HaG9x5639fLnbl.XLf6', 'default_head.jpg', 2, 1, 0);
INSERT INTO `user` VALUES (20, 'qwe', 'qwe', '$2a$10$cqS47p0t3qg9L7qRerSHCOGrWRJCFXJcx/HaG9x5639fLnbl.XLf6', 'default_head.jpg', 2, 1, 0);
INSERT INTO `user` VALUES (21, '老板', 'boss', '$2a$10$cqS47p0t3qg9L7qRerSHCOGrWRJCFXJcx/HaG9x5639fLnbl.XLf6', 'default_head.jpg', 2, 1, 0);
INSERT INTO `user` VALUES (22, 'lin', 'lin', '$2a$10$cqS47p0t3qg9L7qRerSHCOGrWRJCFXJcx/HaG9x5639fLnbl.XLf6', 'default_head.jpg', 1, 1, 0);
INSERT INTO `user` VALUES (23, 'zx', 'zx', '$2a$10$cqS47p0t3qg9L7qRerSHCOGrWRJCFXJcx/HaG9x5639fLnbl.XLf6', 'default_head.jpg', 1, 1, 0);
